    ...
    <div class="insideCont">
        <div class="insideLeft">
            ...
            <div class="detailsCont">
                <h3><s:property value="#theActivity.act_title" /> </h3>
                <time><s:date name="#theActivity.start_time" format="yyyy-MM-dd"/>　主办方：<span class="red"><s:property value="#theActivity.sponsor"/></span></time>
                ...
                <div class="detaPar">
                    <div style="text-align:center;">
                        <s:property value="#theActivity.act_content" escape="false"/>
                    </div>
                </div>
                <!--detaPar/-->
                <!--分页开始-->
